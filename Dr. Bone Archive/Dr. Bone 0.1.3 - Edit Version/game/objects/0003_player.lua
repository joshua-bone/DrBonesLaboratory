...
this.examples=function(T,F)
  return {{{T,180},F}}   --in the item select screen,returns this, facing south, on top of a floor
end

--rotates direction in editor
this.EditorRotate=EditorRotate

--when painting in the editor, we first search the entire map to see if a Player object is already
--present. If one exists, we remove it, and then add the Player object to the new location.
...
this.sound=LoadSound(WD.."game/sounds/player.wav")  --this is for if you cannot move
...
--STATS
  --this.a.power=1   --bottom of the food chain
