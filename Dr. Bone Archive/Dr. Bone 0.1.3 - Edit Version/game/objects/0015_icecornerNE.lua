...
---------------------------------------------------------------------------------------------------
this.guid="940deca7-94ad-41fe-aadb-bedac2081e40"
this.name="Ice Corner NE"
...
this.rules={} --ice corner NE        
this.rules[dirs["N"]]=dirs["W"]   -- N -> W                      
this.rules[dirs["E"]]=dirs["S"]   -- E -> S                     
...
this.TestEnter=function(this,obj,speed,force,newx,newy,newz)
  ...
  if d==1 or not this.rules[d] then 
    return 0,0 
  end --can't enter from below or from S or W
  return speed, force   
end
